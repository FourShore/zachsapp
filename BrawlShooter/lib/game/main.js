...
MyGame = ig.Box2DGame.extend({
	...
	init: function() {
		// Bind keys
		ig.input.bind( ig.KEY.LEFT_ARROW, 'left1' );
		ig.input.bind( ig.KEY.RIGHT_ARROW, 'right1' );
		ig.input.bind( ig.KEY.N, 'jump1' );
		ig.input.bind( ig.KEY.M, 'shoot1' );

		ig.input.bind( ig.KEY.W, 'left2' );
		ig.input.bind( ig.KEY.R, 'right2' );
		ig.input.bind( ig.KEY._1, 'jump2' );
		ig.input.bind( ig.KEY._2, 'shoot2' );
...
if( ig.ua.iPad ) {
	...
	ig.main('#canvas', MyGame, 60, 625, 322, 2);
}
